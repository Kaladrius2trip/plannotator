...
export const Settings: React.FC<SettingsProps> = ({
  ...
  const [bear, setBear] = useState<BearSettings>({
    enabled: false,
    customTags: "",
    tagPosition: "append",
    autoSave: false,
  });
  const [octarine, setOctarine] = useState<OctarineSettings>({
    enabled: false,
    workspace: "",
    folder: "plannotator",
    autoSave: false,
  });
  const [agent, setAgent] = useState<AgentSwitchSettings>({
    switchTo: "build",
  });
  const [planSave, setPlanSave] = useState<PlanSaveSettings>({
    enabled: true,
    customPath: null,
  });
  ...
  const [autoCloseDelay, setAutoCloseDelayState] =
    useState<AutoCloseDelay>("off");
  const [defaultNotesApp, setDefaultNotesApp] =
    useState<DefaultNotesApp>("ask");
  ...
  const octarineDefaultSaveAvailable =
    octarine.enabled && octarine.workspace.trim().length > 0;
  ...
  useEffect(() => {
    if (showDialog) {
      ...
      setAgent(getAgentSwitchSettings(project));
  ...
  const handleAgentChange = (
    switchTo: AgentSwitchSettings["switchTo"],
    customName?: string,
  ) => {
    const newSettings = {
      switchTo,
      customName: customName ?? agent.customName,
    };
    setAgent(newSettings);
    saveAgentSwitchSettings(newSettings, project);
  };
                ...
                <nav className="md:hidden flex overflow-x-auto border-b border-border px-2 py-1.5 gap-1 flex-shrink-0">
                  {[...mainTabs, ...integrationTabs].map((tab) => (
                    ...
                    >
                      {tab.label}
                      {showNewHints &&
                        (tab.id === "display" || tab.id === "labels") && (
                          <span className="text-[8px] font-semibold uppercase tracking-wide px-1 py-px rounded-full bg-primary/15 text-primary leading-none">
                            new
                          </span>
                        )}
                    </button>
                  ...
                  <div className="space-y-0.5">
                    {mainTabs.map((tab) => (
                      ...
                      >
                        ...
                        {showNewHints &&
                          (tab.id === "display" || tab.id === "labels") && (
                            <span className="text-[9px] font-semibold uppercase tracking-wide px-1.5 py-0.5 rounded-full bg-primary/15 text-primary leading-none">
                              new
                            </span>
                          )}
                      </button>
                  ...
                  {activeTab === "general" && (
                    <>
                                ...
                                onChange={(e) => {
                                  ...
                                  if (
                                    ...
                                    if (!validateAgent(customName)) {
                                      setAgentWarning(
                                        `Agent "${customName}" not found in OpenCode. It may cause errors.`,
                                      );
                                    } else {
                                      setAgentWarning(null);
                                    }
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-[10px] text-muted-foreground/70">
                          {
                            AUTO_CLOSE_OPTIONS.find(
                              (o) => o.value === autoCloseDelay,
                            )?.description
                          }
                        </div>
                      </div>
                        ...
                        <div className="flex items-center gap-1 bg-muted/50 rounded-lg p-0.5">
                          {PLAN_WIDTH_OPTIONS.map((opt) => (
                            <button
                              key={opt.id}
                              onClick={() =>
                                handleUIPrefsChange({ planWidth: opt.id })
                              }
                    ...
                    <>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            onClick={() =>
                              handlePlanSaveChange({
                                enabled: !planSave.enabled,
                              })
                            }
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleDefaultNotesAppChange(
                              e.target.value as DefaultNotesApp,
                            )
                          }
                          className="w-full px-3 py-2 bg-muted rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-primary/50 cursor-pointer"
                        >
                          ...
                          {octarineDefaultSaveAvailable && (
                            <option value="octarine">Octarine</option>
                          )}
                        </select>
                        <div className="text-[10px] text-muted-foreground/70">
                          {defaultNotesApp === "ask"
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <span className="flex items-center gap-2">
                            <span
                              className={`text-[10px] font-medium ${bear.enabled ? "text-primary" : "text-muted-foreground/50"}`}
                            >
                        ...
                        >
                          ...
                          <span className="flex items-center gap-2">
                            <span
                              className={`text-[10px] font-medium ${octarine.enabled ? "text-primary" : "text-muted-foreground/50"}`}
                            >
                            ...
                            >
                              ...
                              {isEditingTip && (
                                <div
                                  ...
                                  style={{
                                    animation: "tip-slide-open 0.15s ease-out",
                                  }}
                                >
                                  <svg
                                  ...
                                  <input
                                    ...
                                    onChange={(e) =>
                                      setEditingTipValue(e.target.value)
                                    }
                                    onKeyDown={(e) => {
                                      if (e.key === "Enter") {
                                        const updated = [...quickLabelsState];
                          ...
                          <div className="space-y-3">
                                ...
                                {vaultsLoading ? (
                                  ...
                                  <>
                                    ...
                                    >
                                      ...
                                      <option value={CUSTOM_PATH_SENTINEL}>
                                        Custom path...
                                      </option>
                                    </select>
                                    {obsidian.vaultPath ===
                              ...
                              <div className="text-[10px] text-muted-foreground/70">
                                ...
                                {(() => {
                                  ...
                                  const vars: Record<string, string> = {
                                    ...
                                    MM: String(now.getMonth() + 1).padStart(
                                      2,
                                      "0",
                                    ),
                                    ...
                                    mm: String(now.getMinutes()).padStart(
                                      2,
                                      "0",
                                    ),
                                    ss: String(now.getSeconds()).padStart(
                                      2,
                                      "0",
                                    ),
                                    ampm: h24 >= 12 ? "pm" : "am",
                                  ...
                                  if (obsidian.filenameSeparator === "dash")
                                    ...
                                    obsidian.filenameSeparator === "underscore"
                                  )
                            ...
                            <div className="space-y-1.5">
                              ...
                              <select
                                ...
                                onChange={(e) =>
                                  handleObsidianChange({
                                    filenameSeparator: e.target.value as
                                      | "space"
                                      | "dash"
                                      | "underscore",
                                  })
                              ...
                              <div className="text-[10px] text-muted-foreground/70">
                                Replaces spaces in the generated filename.
                                Useful when working with CLI tools in your
                                vault.
                              </div>
                            </div>
...
---`}
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <div className="text-[10px] text-muted-foreground">
                                  Automatically save to Obsidian when a plan
                                  loads, before you approve or deny
                                </div>
                              </div>
                              <button
                                role="switch"
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <div className="text-[10px] text-muted-foreground">
                                  Browse and annotate vault files from the
                                  sidebar
                                </div>
                              </div>
                              <button
                    ...
                    <>
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleBearChange({ enabled: !bear.enabled })
                          }
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        ...
                        <div className="mt-3 space-y-3">
                          <div className="space-y-1.5 pl-0.5">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleBearChange({ customTags: e.target.value })
                              }
                              onBlur={(e) =>
                                handleBearChange({
                                  customTags: normalizeTags(e.target.value),
                                })
                              }
                            ...
                            />
                            <div className="text-[10px] text-muted-foreground">
                              Comma-separated, kebab-case. Leave empty for
                              auto-generated tags.
                            </div>
                          </div>
                          <div className="space-y-1.5 pl-0.5">
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <div className="text-[10px] text-muted-foreground">
                                Automatically save to Bear when a plan loads,
                                before you approve or deny
                              </div>
                            </div>
                            <button
                              role="switch"
                              ...
                              onClick={() =>
                                handleBearChange({ autoSave: !bear.autoSave })
                              }
                              className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors ${
                    ...
                    <>
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleOctarineChange({ enabled: !octarine.enabled })
                          }
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        ...
                        <div className="mt-3 space-y-3">
                          ...
                          <div className="space-y-1.5 pl-0.5">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleOctarineChange({ folder: e.target.value })
                              }
                              placeholder="plannotator"
                              className="w-full px-3 py-2 bg-muted rounded-lg text-xs font-mono placeholder:text-muted-foreground/50 focus:outline-none focus:ring-1 focus:ring-primary/50"
                            />
                          ...
                          <div className="text-[10px] text-muted-foreground/70">
                            Plans saved to: {octarine.workspace || "..."} /{" "}
                            {octarine.folder || "plannotator"}/
                          </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <div className="text-[10px] text-muted-foreground">
                                Automatically save to Octarine when a plan
                                loads, before you approve or deny
                              </div>
                            </div>
                            <button
